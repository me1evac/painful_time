...
execute as @a[scores={welcome=1..}] at @s run tellraw @s ["",{"text":"Click here for Discord","color":"green","underlined":"true","bold":"true", "clickEvent":{"action":"open_url","value":"https://discord.gg/uCPfPBvsRJ"}},""]
